...
| breiteSatz |  | Notenstufen Abzug pro fehlendem Meter Breite, je feel-safe-Klasse und Tempo (ruhig ≤ 30, schnell > 30) | Fahrbahn seit dem 22.09.2026: VORLÄUFIGE KALIBRIERUNG 1,0 für beide Tempi (Nutzerentscheid), aus der Berner Bildumfrage 2026 (docs/09, Kapitel 5.5). Die Berner Schätzwerte 1,33 (1,5 auf 1,8 m) und 1,49 (1,5 auf 2,0 m) Noten/m liegen über den Berliner Messwerten 0,65/0,74, die zwischen 2,0 und 3,5 m gemessen und auf schmalere Streifen extrapoliert waren; 1,0 ist der gerundete Durchschnitt der vier Werte und liegt im Fenster 0,74 bis 1,05, das mit allen vier Vertrauensbereichen verträglich ist. KEINE Tempo-Spanne mehr auf der Fahrbahn: die Berner Umfrage unterscheidet Verkehrsmenge, nicht Tempo. Berliner Herleitung davor (12./13.08.2026, P10-U/P13): GESTRICHELT-Schnitt 9,3 bzw. 10,5 Pkt/m durch Kurs 14,2 = 0,65/0,74. Hinter baulicher Trennung unverändert seit dem 13.08.2026 im POLLER-ONLY-Grau-Schnitt (P14, derselbe Pool wie der Radweg-Anker): 3,4 bzw. 5,3 Pkt/m = 0,24/0,38, tempoabhängig. Fahrgassen-Bänder (Velostrasse, Umweltspur) bleiben normativ bei 0,9 für beide Tempi. |
